package cn.javadog.kafka.quickstart.simpledemo;
...
//        properties.put("buffer.memory", 33554432);
		...
		//使用的拦截器
		properties.put("interceptor.classes", "cn.javadog.kafka.quickstart.interceptor.ProducerInterceptorDemo");
	...
	public static void main(String[] args) throws ExecutionException, InterruptedException {
		...
		for (int i = 0; i < 100; i++) {
			...
			ProducerRecord<String, String> message = new ProducerRecord<String, String>("TestTopicWithInterceptor", "key"
				, "calm" + i);
			// 同步发送消息
